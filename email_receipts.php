...
<div class="row">
	...
	<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="jarviswidget jarviswidget-color-purity" id="wid-id-1" data-widget-editbutton="false">
			<header>	
				<span class="small_icon"><i class="fa fa-envelope-o"></i>	</span>	
				<h2>Email Receipt</h2>
			</header>
...
if(isset($_POST['submit'])){
			...
			{
				$_SESSION['msg']="Problem In Sending Email Receipts";
			}*/
...
<form id="checkout-form" name="checkout-form" method="post" onsubmit="return checkParameters();" action="" class="smart-form">
            ...
            <table style="width:80%; background:#f1f1f1;" class="table table-bordered">
              ...
              <?php } ?>
                ...
                <tr>
                	<th style="width:70%;"><strong>Attach Receipt</strong></th>
                    <th><input type="file" class="form-control" name="receipt">
                    </th>
                </tr>
                <tr>
                	<th style="width:70%;"><strong>Description</strong></th>
                	<td colspan="3"><textarea name="promo_message" id="promo_message" style=" width:1185px; max-height:200px; height:200px;" placeholder="Insert data here"></textarea></td>
                </tr>
                
                <tr>
                	<td colspan="2" style="text-align:right;">
               			<input type="submit" name="submit" class="btn btn-sm btn-primary"  style="margin:5px;" value="Send Receipt">
                	</td>
                </tr>
            </table>
        	</div>
