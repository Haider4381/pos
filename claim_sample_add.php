        ...
        <tbody>
          ...
          <?php } else { foreach ($docs as $d) { ?>
            <tr>
              ...
              <td><?= h($d['s_Remarks']) ?></td>
              <td class="actions">
                <a class="btn btn-info btn-xs" target="_blank" href="claim_sample_print.php?s_id=<?= (int)$d['s_id'] ?>"><i class="fa fa-print"></i> Print</a>
                <a class="btn btn-primary btn-xs" href="claim_sample_edit.php?s_id=<?= (int)$d['s_id'] ?>"><i class="fa fa-pencil"></i> Edit</a>
                <form method="post" action="claim_sample_delete.php" style="display:inline;" onsubmit="return confirm('Delete this document? This will remove its stock movement. Continue?');">
                  <input type="hidden" name="s_id" value="<?= (int)$d['s_id'] ?>">
