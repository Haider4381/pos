...
$sQ="SELECT
	Q.q_id,Q.branch_id,Q.q_Number,Q.q_TotalAmount,Q.q_NetAmount,Q.q_Tax, Q.q_TaxAmount, Q.q_SaleMode, Q.q_PaymentType, Q.q_Discount, Q.q_DiscountAmount,
	Q.q_SaleMode, Q.q_PaidAmount, Q.q_CreatedOn,Q.q_totalitems, Q.q_RemarksExternal,
	C.client_id,C.client_Name,C.client_Phone,
	QD.item_IMEI,QD.item_Qty, QD.item_SalePrice,QD.item_NetPrice,QD.item_id,QD.item_DiscountPrice,QD.item_DiscountPercentage,QD.item_discount_amount_per_item,
	I.item_Name,I.item_Code,
	u_FullName as username,
	adm_branch.branch_CustomerPaymentPolicy, adm_branch.branch_ShowPolicy

FROM adm_quotation AS Q
INNER JOIN adm_quotation_detail AS QD ON QD.q_id=Q.q_id
INNER JOIN adm_item AS I ON I.item_id=QD.item_id
INNER JOIN adm_client AS C ON C.client_id=Q.client_id
LEFT JOIN u_user  ON u_user.u_id=Q.u_id
INNER JOIN adm_branch ON adm_branch.branch_id=Q.branch_id
...
if($print_header=='yes')
{
	...
	<tr><td colspan="2" style="text-align:center;font-size:30px;"><strong>Quotation Receipt</strong></td></tr>
	</table>
<?php
}else
{
...
<table style="width:100%; font-size:11px;"  align="center" border="0">
	...
	<tr>
		<td style="width:50%;"><?php echo date('M d, Y',strtotime($sRow[0]['q_CreatedOn']));?></td>
		<td style=" width:50%;text-align:right;"><?php echo date('h:i A',strtotime($sRow[0]['q_CreatedOn']));?></td>
	</tr>
    <tr>
    	<td>Transaction#</td>
		<td style="text-align:right;"><?php echo $sRow[0]['q_Number'];?></td>
	</tr>
    <tr>
    	<td>Sale Mode</td>
		<td style="text-align:right;"><?php echo $sRow[0]['q_SaleMode'];?></td>
	</tr>
    <!--<tr>
    	<td>Payment Type</td>
		<td style="text-align:right;"><?php echo $sRow[0]['q_PaymentType'];?></td>
	</tr>-->
	<tr>
...
<table style="width:100%;border-collapse: collapse;border-top: 1px solid #000; font-size:14px;" align="center" border="0"> 
 ...
 <td style="width:40%;border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $sRow[0]['q_totalitems'];?></td>
 </tr>
 
 <tr>
 <td style=" padding:3px; text-align:right;"><strong>Sub Total: </strong></td>
 <td style=" border-bottom:1px solid #000;padding:3px;text-align:right; ;"><?php echo $currency_symbol.number_format($sRow[0]['q_TotalAmount'],2);?></td>
 </tr>
 
 <tr>
 <td style=" padding:3px; text-align:right;"><strong>Discount: </strong></td>
 <td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol.number_format($sRow[0]['q_DiscountAmount'],2);?></td>
 </tr>
 
 <tr>
 <td style=" padding:3px; text-align:right;"><strong>Total VAT: </strong></td>
 <td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol.number_format($sRow[0]['q_TaxAmount'],2);?></td>
 </tr>
 
<tr>
 <td style=" padding:3px; text-align:right;"><strong>Amount Due: </strong></td>
 <td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol.number_format($sRow[0]['q_NetAmount'],2);?></td>
 </tr>
<?php if($sRow[0]['q_SaleMode']=='cash' && $sRow[0]['q_PaidAmount']>=$sRow[0]['q_NetAmount']){ ?>
	
    <tr>
         <td style=" padding:3px; text-align:right;"><strong>Cash: </strong></td>
         <td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol.number_format($sRow[0]['q_PaidAmount'],2);?></td>
         </tr>
         
         <tr>
         <td style=" padding:3px; text-align:right;"><strong>Change: </strong></td>
         <td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol.number_format($sRow[0]['q_PaidAmount']-$sRow[0]['q_NetAmount'],2);?></td>
	</tr>
...
<?php if($sRow[0]['q_SaleMode']=='cash' && $sRow[0]['q_PaidAmount']<$sRow[0]['q_NetAmount']){ ?>
    ...
    <tr>
         ...
         <td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol.number_format($sRow[0]['q_NetAmount']-$sRow[0]['q_PaidAmount'],2);?></td>
         </tr>
...
<tr>
	...
	<td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol.number_format($balance-$sRow[0]['q_NetAmount']+$sRow[0]['q_PaidAmount'],0);?></td>
</tr>
<tr>
...
<table style="width:100%;font-size:13px;" align="center" border="0"> 
 ...
 <td style="width:75%;border-bottom:1px solid #000;padding:3px;"> <?php echo $sRow[0]['q_RemarksExternal'];?></td>
 </tr>
