...
$sQ="SELECT
	...
	S.s_SaleMode, S.s_PaidAmount, S.s_CreatedOn,S.s_totalitems, S.s_RemarksExternal,
...
if($print_header=='yes')
{
	...
	//$logo_source='<img src="img/mart-logo.png" height="70">';
	$logo_source='';
	...
	<br/>
	<hr />
	<table style="width:100%;     font-size: 15px; text-align:center;" align="center" border="0"  >
		<!--<tr><td><?=$logo_source?></td></tr>-->
		<tr><td><img src="img/mart-logo.png" height="70" ></td></tr>
...
else
{
	...
	<table style="width:100%;     font-size: 15px; text-align:center;" align="center" border="0"  >
		<!--<tr><td><?=$logo_source?></td></tr>-->
		<tr><td><img src="img/mart-logo2.png" height="70" style="width: 100%; height: 52px;" ></td></tr>
		<tr><td style="text-align:center;"><h1><?php echo $branchRow['branch_Name'];?></h1><?php echo $branchRow['branch_Address'];?><br /><?php echo $branchRow['branch_Phone1'];?></td></tr>
	</table>
	<hr />
	<table style="width:100%; font-size:11px;"  align="center" border="0">

	<tr><td colspan="2" style="text-align:center;font-size:16px;"><strong>Sale Receipt</strong></td></tr>
	</table>
	<?php
...
<table style="width:100%; font-size:14px;"  align="center" border="0">
   ...
   <!-- <tr>
	...
	<tr>
		<td colspan="2">Customer: &nbsp;&nbsp;<?php echo $sRow[0]['client_Name'];?> </td>
...
<table align="center" border="1" style="width:100%;border:0px solid #666;border-collapse:collapse;font-size:14px;font-family:Verdana, Geneva, sans-serif;" cellpadding="2">
 <tr style="border-bottom:4px solid #666;">
 <td style="text-align:center;width:8%; border-bottom:4px solid #666;"><strong>Sr #</strong></td> 
 <td style="text-align:center;width:20%;border-bottom:4px solid #666;"><strong>Product</strong></td>
 <!--<td style="text-align:center;width:10%; border-bottom:1px solid #666;"><strong>Item Code</strong></td>-->  
 <td style="text-align:center;width:5%; border-bottom:4px solid #666;"><strong>Qty</strong></td>
 <td style="text-align:center; width:10%;border-bottom:4px solid #666;"><strong>Price</strong></td>
 ...
 <td style="text-align:center; width:10%;border-bottom:4px solid #666;"><strong>Total</strong></td>
	</tr>
...
<tr style="">
	...
	<td style="text-align:center;  vertical-align:top; text-align: center;"><?php echo round($r['item_SalePrice']);?></td>
	<!--<td style="text-align:center;  vertical-align:top; text-align: center;"><?php echo round($r['item_DiscountPercentage']);?></td>-->
	<td style="text-align:center;  vertical-align:top; text-align: center;"><?php echo number_format($r['item_DiscountPrice'],2);?></td>
	<td style="text-align:center; vertical-align:top; text-align: center;"><?php echo round($r['item_NetPrice']);?></td>
</tr>
...
<table style="width:100%;border-collapse: collapse;border-top: 1px solid #000; font-size:14px;" align="center" border="0"> 
 ...
 <td style=" border-bottom:1px solid #000;padding:3px;text-align:right; ;"><?php echo $currency_symbol." ".round($sRow[0]['s_TotalAmount']);?></td>
 </tr>
 
 <tr>
 <td style=" padding:3px; text-align:right;"><strong>Discount: </strong></td>
 <td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol.round($sRow[0]['s_DiscountAmount']);?></td>
 </tr>
 
<!-- <tr>
 <td style=" padding:3px; text-align:right;"><strong>Total VAT: </strong></td>
 <td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol.round($sRow[0]['s_TaxAmount']);?></td>
 </tr>-->
 
<tr>
 <td style=" padding:3px; text-align:right;"><strong>Amount Due: </strong></td>
 <td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol." ".round($sRow[0]['s_NetAmount']);?></td>
 </tr>
<?php if($sRow[0]['s_SaleMode']=='cash' && $sRow[0]['s_PaidAmount']>=$sRow[0]['s_NetAmount']){ ?>
    ...
    <tr>
         ...
         <td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol." ".round($sRow[0]['s_PaidAmount']);?></td>
         </tr>
         
         <tr>
         <td style=" padding:3px; text-align:right;"><strong>Change: </strong></td>
         <td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol." ".round($sRow[0]['s_PaidAmount']-$sRow[0]['s_NetAmount']);?></td>
	</tr>
...
<?php if($sRow[0]['s_SaleMode']=='cash' && $sRow[0]['s_PaidAmount']<$sRow[0]['s_NetAmount']){ ?>
    ...
    <tr>
         ...
         <td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol.round($sRow[0]['s_NetAmount']-$sRow[0]['s_PaidAmount']);?></td>
         </tr>
...
<tr>
	...
	<td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol.round($balance-$sRow[0]['s_NetAmount']+$sRow[0]['s_PaidAmount'],0);?></td>
</tr>
<tr>
	<td style=" padding:3px; text-align:right;"><strong>Current Balance</strong></td>
	<td style=" border-bottom:1px solid #000;padding:3px;text-align:right;"><?php echo $currency_symbol.round($balance,0);?></td>
</tr>
...
<!--<table style="width:100%;font-size:13px;" align="center" border="0"> 
 ...
 <td style="width:75%;border-bottom:1px solid #000;padding:3px;"> <?php echo $sRow[0]['s_RemarksExternal'];?></td>
 </tr>
...
<strong style="text-align:center;display: block;font-size: 13px;">Software Develope By:<br/> websofthouse.net (0300-7537538)</strong>-->
