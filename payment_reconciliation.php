...
<table id="example" class="display" style="width:100%">
    ...
    font-weight: bold;">
                    <tr >
						...
						<td width="300px" style="text-align: left;">Customer Name</td>
						<td width="200px" style="text-align: center;">Total Sale</td>
						<td width="200px" style="text-align: center;">Sale Return</td>
						<td width="200px" style="text-align: center;">Bill Payment</td>
						<td width="250px" style="text-align: center;">Bill Payment Return</td>
						<td width="250px" style="text-align: center;">Balance</td>
					</tr>
                    <thead>
                    <tbody>							
<?php
...
?>
					<tr>
						...
						<td style="text-align: leftt; font-weight: bold;font-size: 14px;"><?php echo $row['client_Name'];?></td>
