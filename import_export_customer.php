            ...
            <table style="width:100%; background:#f1f1f1;" class="table" border="0">
            	<tr>
            		<td>
			            	...
			            	<tr>
			                	<th style="width:50%;"><strong>Import Customers</strong></th>
			                	<th style="width:50%;"><strong>Export Customers</strong></th>
			                </tr>
			                <tr>
			                	<td>
			                		
			                                 <div id="upload">
			                                    <form enctype="multipart/form-data" action="csv.php?action=importcustomer" method="post">
			                                      <input type="file" data-filename-placement="inside" name="csv">
			                    ...
			                    <td>
			                                ...
			                                <form action="csv.php?action=customerexport" method="post">       
            		...
            		<td>
			                ...
			                <tr>
			                	...
			                	if(isset($_REQUEST['msg']))
			                	{
			                		...
			                		{
			                			echo "<h4>Cusotmers Imported Successfully</h4>";
			                		}
			                	}	 
			                      ?>          
			                    </td>
